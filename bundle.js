...
var ActionButton = function () {
  function ActionButton(bridge, parentDOM) {
  ...
  _createClass(ActionButton, [{
    ...
    value: function handleClick() {
      this.typeOfAction === 'HIDE_SINGLE' ? this.bridge.sendAction(this.typeOfAction, this.parent.classList) : this.bridge.sendAction(this.typeOfAction, this.payload);
    }
  }, {
    key: 'paint',
...
var _bridge = __webpack_require__(71);
...
var _SuggestionList = __webpack_require__(78);

var _SuggestionList2 = _interopRequireDefault(_SuggestionList);

var _ErrorMex = __webpack_require__(79);

var _ErrorMex2 = _interopRequireDefault(_ErrorMex);

var _Map = __webpack_require__(80);

var _Map2 = _interopRequireDefault(_Map);

var _Single = __webpack_require__(81);
...
var map = new _Map2.default(bridge);
var navbar = new _Navbar2.default(bridge);
//const inputField = new InputField(bridge)
var suggestionList = new _SuggestionList2.default(bridge);
var errorMex = new _ErrorMex2.default(bridge);
var single = new _Single2.default(bridge);
var filter = new _Filter2.default(bridge);
...
function Bridge() {
  ...
  */
  function notifyObserver(type) {
    var result = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

    observerList[type].forEach(function (observer) {
  ...
  */
  function addMarker(type) {
    _createMarkersArray().then(function (markerArray) {
  ...
  */
  function _createMarkersArray() {
    ...
    return new Promise(function (res, rej) {
      _API2.default.getEventsList().then(function (json) {
        for (var key in json) {
  ...
  */
  function createSuggestionList(type, payload) {
    ...
    var re = /^[a-zA-Z]|[a-zA-Z]+[a-zA-Z\'\-\s\b]+$/i;
    if (payload.match(new RegExp(re))) {
      notifyObserver('HIDE_ERROR');
      payload = payload[0].toUpperCase() + payload.slice(1);
      _API2.default.getCitiesList(payload).then(function (data) {
        var filter = data.filter(function (city) {
          return city.n.startsWith(payload);
        });
  ...
  function hideSingle(classList) {
    ...
    classList.contains('filter') ? notifyObserver('HIDE_FILTER') : notifyObserver('HIDE_SINGLE');
  ...
  */
  ...
  return {
    sendAction: function sendAction(type, payload) {
      actionChecker(type, payload);
    },
    registerObserver: function registerObserver(item) {
...
var API = function () {
  ...
  _createClass(API, null, [{
    ...
    key: 'getCitiesList',
    value: function getCitiesList(i) {
      var firstLetter = i[0];
      return new Promise(function (res, rej) {
        //Check if data are present in cache
        _cache2.default.checkCity(firstLetter).then(function (check) {
          if (check) {
            _cache2.default.getCity(firstLetter).then(function (data) {
              return res(data);
            });
          } else {
            var url = 'assets/data/' + firstLetter + '.json';
            API._makeAJAX(url).then(function (data) {
              _cache2.default.setCity(firstLetter, data);
              res(data);
            }).catch(function (err) {
              return rej(err);
            });
    ...
    key: 'getEventsList',
    value: function getEventsList(geo) {
      return new Promise(function (res, rej) {
        var url = 'assets/data/eventi.json';
        if (_cache2.default.storageAvaible('sessionStorage')) {
          if (_cache2.default.checkEvents()) {
            res(_cache2.default.getEvents());
          } else {
            API._makeAJAX(url).then(function (data) {
              _cache2.default.setEvents(data);
              res(data);
            }).catch(function (err) {
              return rej(err);
            });
...
var Cache = function () {
  ...
  _createClass(Cache, null, [{
    ...
    key: 'getCity',
    value: function getCity(key) {
      return new Promise(function (res, rej) {
        _localforage2.default.getItem(key).then(function (data) {
          return res(data);
        });
      });
    }
    ...
    key: 'setCity',
    value: function setCity(key, data) {
      _localforage2.default.setItem(key, data);
    }
    ...
    */
    ...
    key: 'storageAvaible',
    value: function storageAvaible(type) {
      try {
...
var _InputField = __webpack_require__(77);

var _InputField2 = _interopRequireDefault(_InputField);

var _ActionButton = __webpack_require__(34);
...
var Navbar = function () {
  function Navbar(bridge) {
    ...
    this.backBtn = new _ActionButton2.default(this.bridge, this.DOMElement, 'HIDE_SINGLE', '', 'back-btn');
    this.inputField = new _InputField2.default(this.bridge, this.DOMElement);
    this.resetBtn = new _ActionButton2.default(this.bridge, this.DOMElement, 'RESET_VALUE', '', 'reset-btn');
  }

  _createClass(Navbar, [{
    key: 'notify',
    value: function notify(type, scene) {
      switch (scene) {
        case 'initial':
...
var InputField = function () {
  function InputField(bridge, parentDOM) {
  ...
  _createClass(InputField, [{
    ...
    value: function handleInput(e) {
      ...
      if (e.keyCode !== 16) {
        this.timeout = setTimeout(function () {
          _this.bridge.sendAction('CREATE_SUGGESTION_LIST', e.target.value);
        }, 800);
      }
    }
  }, {
    ...
    key: 'notify',
    value: function notify(type, payload) {
      switch (type) {
        case 'SET_VALUE':
        case 'RESET_VALUE':
...
var SuggestionList = function () {
  function SuggestionList(bridge) {
    ...
    this.bridge.registerObserver(this, 'CREATE_SUGGESTION_LIST', 'HIDE_SUGGESTION');
  }

  _createClass(SuggestionList, [{
    key: 'handleClick',
    value: function handleClick(ev) {
      var single = ev.target.closest('.single-el');
      if (!single) return;
      var datasetGeo = single.dataset.geo,
    ...
    key: 'notify',
    value: function notify(type, result) {
      switch (type) {
    ...
    key: 'paintList',
    value: function paintList(result) {
    ...
    key: 'paintSingle',
    value: function paintSingle(props) {
      var single = document.createElement('div');
      var nameLength = 15; //MAX length for cities name
...
var ErrorMex = function () {
  function ErrorMex(bridge) {
    _classCallCheck(this, ErrorMex);
...
var Map = function () {
    function Map(bridge) {
        ...
        var filterButton = new _ActionButton2.default(this.bridge, this.DOMElement, 'SHOW_FILTER', '', 'filter');
    ...
    _createClass(Map, [{
        ...
        value: function addMarker(arr) {
            ...
            var _loop = function _loop(i, len) {
                ...
                _this.markerArrays.push(marker);
            ...
            var markerCluster = new MarkerClusterer(this.map, this.markerArrays, { imagePath: './assets/img/m' });
        }
    }, {
        key: "checkInBounds",
        value: function checkInBounds(zoom, bounds) {
            var markersInBounds = 0;
            for (var i = 0, len = this.markerArrays.length; i < len && markersInBounds === 0; i++) {
        ...
        key: "clearMarkerFromMap",
        value: function clearMarkerFromMap() {
            for (var i = 0, len = this.markerArrays.length; i < len; i++) {
                this.markerArrays[i].setMap(null);
            }
        }
    }, {
        key: "handleClickMarker",
        value: function handleClickMarker(marker) {
            var props = {
        ...
        key: "notify",
        value: function notify(mex, payload) {
...
var Single = function () {
  ...
  _createClass(Single, [{
    key: 'paintSingle',
    value: function paintSingle(infos) {
      var frag = document.createDocumentFragment();
      ...
      var oblo = document.createElement('div');
      ...
      service.getDistanceMatrix({
        ...
        if (status == 'OK') {
          for (var i = 0, len = response.rows.length; i < len; i++) {
            for (var j = 0, _len = response.rows[i].elements.length; j < _len; j++) {
          ...
          this.detail.querySelector('#eta').innerHTML = '<h4>tempo in macchina </h4><h3>Non ci \xE8 stato possibile calcolare</h3>';
        }
      });
    }
  }, {
    key: 'notify',
    value: function notify(type, infos) {
      switch (type) {
        case 'HIDE_SINGLE':
          this.DOMElement.style.display = 'none';
          break;
...
var Filter = function () {
  ...
  _createClass(Filter, [{
    ...
    key: '_getDistance',
    value: function _getDistance(c, p) {
      var cR = this._toRadians(c);
      var pR = this._toRadians(p);
    ...
    value: function filterByDistance(ev) {
      var self = this;
      var byDistance = [];
      if (ev.target.name !== 'selector-dist') {
        return false;
      }
      var query = parseInt(ev.target.value);
      if (this.filtered.filterApplied.includes('distance')) {
        this.filtered['data'] = this.events.filter(function (el) {
          return self._getDistance(self.center, el.geo) <= query;
        });
        this.filtered['filteredApplied'].push('distance');
      }

      if (this.filtered.length === 0) {
        byDistance = this.events.filter(function (el) {
          return self._getDistance(self.center, el.geo) <= query;
        });
      } else {
        byDistance = this.filtered.filter(function (el) {
          return self._getDistance(self.center, el.geo) <= query;
        });
      }
      this.updateResult(byDistance.length);
      this.byDistance = byDistance.reduce(function (map, obj) {
        map[obj.id] = obj;
        return map;
      }, {});
    ...
    key: 'filterByFormat',
    value: function filterByFormat(ev) {
      ...
      var data = this.filtered.length === 0 ? this.events : this.filtered;
      var query = ev.target.value;
      if (query === 'SEALED') {
        byFormat = this.events.filter(function (el) {
          return el['info']['format'] === query;
        });
      } else {
        byFormat = this.filter.filter(function (el) {
          return el['info']['format'] !== query;
        });
      }
    ...
    value: function paint() {
      ...
      container.addEventListener('click', function () {
        var arr = document.querySelectorAll('input[type="radio"]:checked');
        var arrbyfilter = arr.map(function (el) {
          return el.value;
        });
        consolel;
      }, true);
    ...
    key: 'updateResult',
    value: function updateResult(len) {
